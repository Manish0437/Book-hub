...
class Bookshelves extends Component {
  state = {
    ...
    booksApiStatus: booksApiStates.initial,
    booksData: {},
    searchInput: '',
    search: '',
  ...
  getBooksApiData = async () => {
    this.setState({booksApiStatus: booksApiStates.inProgress})
    ...
    if (response.ok === true) {
      ...
      this.setState({
        ...
        booksApiStatus: booksApiStates.success,
      })
    } else {
      this.setState({booksApiStatus: booksApiStates.failure})
    }
  }
  ...
  renderBooks = () => {
    ...
    switch (booksApiStatus) {
      case booksApiStates.success:
        return <>{this.renderBooksSuccessView()}</>
      case booksApiStates.inProgress:
        return <>{this.renderBooksProgressView()}</>
      case booksApiStates.failure:
